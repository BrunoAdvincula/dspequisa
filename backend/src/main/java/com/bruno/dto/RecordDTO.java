...
import com.bruno.entidades.enums.Platform;
...
public class RecordDTO implements Serializable {
	...
	public RecordDTO(Record recordEntity) {
		...
		moment = recordEntity.getMoment();
		name = recordEntity.getName();
		gameTitle = recordEntity.getGame().getTitle();
		gamePlatform = recordEntity.getGame().getPlatform();
		genreName = recordEntity.getGame().getGenre().getName();
	}
